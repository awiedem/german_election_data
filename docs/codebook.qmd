...
**Files:** `county_elec_unharm` (68,937 x 411), `county_elec_harm_21_muni`
(41,941 x 422), `county_elec_harm_21_cty` (2,303 x 419), `county_council_seats`
...
1946--1994, Saarland 1974--1979). Brandenburg has a parsing block but currently
contributes no rows (a tibble name-mangling failure in its Stage 1 parser).
