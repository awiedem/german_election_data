...
`normalise_party()` mapping so that the same political party carries the same
...
constituency level 1990--2025. Vote shares in the municipality- and county-level
...
set of files. Vote shares are proportions of `valid_votes`. Every party that
ever ran is preserved as its own column (352 party columns).

## Municipality level

**Files:** `state_unharm` (149,401 x 366), `state_harm_21` (82,689 x 376),
`state_harm_23` (82,596 x 376), `state_harm_25` (82,466 x 376) in
