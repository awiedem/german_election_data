...
**Files:** `municipal_unharm` (84,829 x 42, 1984–2026), `municipal_harm`
(73,548 x 40, 1990–2026, 2021 boundaries), `municipal_harm_25` (73,295 x
...
**Files:** `county_elec_unharm` (43,474 x 498),
`county_elec_harm_21_muni` (30,212 x 509), `county_elec_harm_21_cty`
(2,177 x 506), `county_council_seats` (7,200 x 22) in
`data/county_elections/final/`.

Shared blocks apply, with 487 party columns. Results are reported at
