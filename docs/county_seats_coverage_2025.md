...
`county_council_seats` is a balanced panel with 7,200 unique county-years: 400 current-boundary counties in every year from 2008 through 2025. The extension adds 15 Schleswig-Holstein results from 2023, 161 results from the 2024 elections in eight states, and the 53 Nordrhein-Westfalen results from the 14 September 2025 Kreistags-/Ratswahl (229 newly parsed election rows in total). Each election result is carried forward through 2025.
...
| Nordrhein-Westfalen 2025 | `Nordrhein-Wetfalen/2025_html/a*kw2500.shtml` | HTML | County code in the official URL | 2025 seats total + per-party seat table | 53 | Complete |
...
- All 229 newly parsed election rows (SH 2023, eight states' 2024, NRW 2025) have a reported total equal to the sum of the nine seat categories.
...
| Kleve (`05154`) | [NRW 2025 county page](https://www.wahlergebnisse.nrw/kommunalwahlen/2025/aktuell/a154000kw2500.shtml) | 62 | CDU, 27 | Match |
| Köln (`05315`) | [NRW 2025 county page](https://www.wahlergebnisse.nrw/kommunalwahlen/2025/aktuell/a315000kw2500.shtml) | 90 | GRÜNE, 22 | Match (also matches the independent municipal Köln 2025 seats) |

## Remaining gaps

The fixed-boundary contract still excludes pre-reform predecessor councils. Municipal seat gaps remain outside this dataset. `government_party` is carried forward from 2022 while a county's council is unchanged, so it is present for 2023–2025 in the states without a new election (NRW, Bayern, Niedersachsen, Hessen and the city-states); it is `NA` from a county's 2023, 2024 or 2025 election onward because the official seat-result sources for those elections do not identify the governing party (420 of the 1,200 rows in 2023–2025, now including the 53 Nordrhein-Westfalen 2025 councils).
