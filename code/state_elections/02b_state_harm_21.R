...
# Pooled party columns (matches federal pipeline definitions)
...
# Calculate total vote share: sum ALL individual party columns (not just major)
# Exclude derived columns to avoid double-counting
